...
export const MATERIALS: Material[] = [
  ...
  // ── 장비 성장 재료 ────────────────────────────────────────────────────────────
  { id: "enhancement_stone", name: "강화석", emoji: "🪨", description: "장비의 레벨을 올리는 데 사용되는 재료. 장비 분해 시 획득한다." },
  // ── 최종 보스 재료 ────────────────────────────────────────────────────────────
  { id: "ormr_essence", name: "만물의 정수", emoji: "🌌", description: "오름을 쓰러뜨리면 얻는 신비로운 정수. 모든 원소의 기운이 담겨 있다." },
];
