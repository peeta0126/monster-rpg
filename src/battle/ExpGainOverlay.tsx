 ...
 * 레벨업 카드.
 *
 * **레벨이 올랐을 때만** 뜬다. 예전에는 승리할 때마다 화면을 통째로 덮었는데, 잡몹
 * 한 마리에 전면 창이 뜨는 건 성장을 보여주는 게 아니라 진행을 끊는 것이었다. 그냥
 * 들어오는 경험치는 하단 상태 줄의 바가 차오르는 것으로 충분하다 — 여기서만 멈춰 선다.
 *
 * 올라간 스탯이 이 창의 존재 이유다. 그건 상태 줄 한 칸에 넣을 수 없다.
 */
