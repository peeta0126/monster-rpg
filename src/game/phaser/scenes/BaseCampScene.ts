...
export default class BaseCampScene extends Phaser.Scene {
  ...
  create() {
    ...
    // ── 왼쪽/상단/오른쪽 외곽 경계 ────────────────────────────────────────────────
    seg(150,    0, 150,  992);   // 왼쪽 외벽 상단 (맵 꼭대기 → y=992)
    seg(150,  992, 204,  992);   // 탑 통로 왼쪽 닫기
    seg(397,  992, 1050, 992);   // 상단 마을 전체 하단 경계 (탑 통로 오른쪽 ~ 동쪽 외벽)
    seg(150,  992, 150, 1350);   // 왼쪽 외벽 하단
    seg(150, 1350, 134, 1378);   // 왼쪽 외벽 → 우물 연결
