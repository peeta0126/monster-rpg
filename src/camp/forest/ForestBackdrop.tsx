 ...
 * 탐험 중 화면에 까는 스크림의 세기.
 *
 * 원화 3장에는 구역 선택 화면 기준 스크림이 이미 구워져 있다. 카드가 놓이는
 ...
 *
 * 왜 겹쳐 두냐면, src 를 갈아끼우면 새 이미지가 디코딩될 때까지 한 프레임이 비어
  ...
  return (
    ...
    <div className="absolute inset-0 z-0 isolate overflow-hidden bg-shadow-900" aria-hidden>
      ...
      {FOREST_AREAS.map((area) => {
        ...
        // 아직 한 번도 안 고른 층은 depth -1. 프리로드만 되고 화면엔 안 나온다.
