                ...
                return item ? (
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: `1px dashed ${isActive ? PALETTE.earth500 : rgba("earth500", 0.45)}`,
                    }}
                  >
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl"
                      style={{ border: `1px dashed ${rgba("earth500", 0.45)}` }}>
                      <PixelIcon name="artifact" size={32} style={{ opacity: 0.2 }} />
                    </div>
                    <div>
                      <p className="text-pixel-sm font-black text-sand-300">
                        {ARTIFACT_SLOT_LABEL[slot]}
                      </p>
                      <EmptyValue>비어 있음 — 눌러서 가방을 거른다</EmptyValue>
                    </div>
                  </button>
                );
              })}
