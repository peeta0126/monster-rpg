export const MONSTER_IMAGE_MAP: Record<string, string> = {
  ...
  aquagon:    "/assets/monsters/aquagon.webp",
  bublock:    "/assets/monsters/bublock.webp",
  bubldon:    "/assets/monsters/bubldon.webp",
  burnox:     "/assets/monsters/burnox.webp",
  hwarong:    "/assets/monsters/hwarong.webp",
  gemto:      "/assets/monsters/gemto.webp",
  gemguard:   "/assets/monsters/gemguard.webp",
  gemlord:    "/assets/monsters/gemlord.webp",
  bingrok:    "/assets/monsters/bingrok.webp",
  sporemus:   "/assets/monsters/sporemus.webp",
  bunggom:    "/assets/monsters/bunggom.webp",
...
export const MONSTER_ART_FACING: Record<string, ArtFacing> = {
  ...
  frostorb:   "front",
  aquavern:   "right",
  aquagon:    "right",   // 아쿠사와 같이 오른쪽을 본다 — 라인 셋 중 둘이 오른쪽이다
  bublock:    "left",
  bubldon:    "left",
  burnox:     "left",
  hwarong:    "front",
