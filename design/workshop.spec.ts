 ...
 *
 * ⚠️ 알려진 문제 — 여기서 검증하지 않는다:
 *    제작/모루 모달이 열려 있어도 플레이어는 방향키로 움직인다. RAF 루프가
 *    menuOpenRef(Tab 메뉴)만 보고 activeStationRef(제작 모달)는 보지 않기 때문이다.
 *    배경 교체 이전부터 그랬다(git 25d07b2~1 확인). SPACE 상호작용은 막혀 있다.
 */
