...
export default defineConfig({
  testDir: ".",
  testMatch: /(capture|visual|fx|responsive|measure|menu|onboarding|autolog|workshop|rendering|artifactFlow|collision|basecampNav|measureForestRun|icons)\.spec\.ts$/,
  timeout: 90 * 1000,
